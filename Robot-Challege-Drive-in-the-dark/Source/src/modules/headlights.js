...
var determineDarkness = function(self, value){
  if (value <= TURN_LIGHT_ON_VALUE && self.robot.isActive) {
    turnLightsOn(self);
  } else if (value > TURN_LIGHT_ON_VALUE && self.robot.isActive && self.hasActivatedLeds) {
    turnLightsOff(self);
