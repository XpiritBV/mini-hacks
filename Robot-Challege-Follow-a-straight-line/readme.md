...
- Clone repository from github, open a command line or terminal and use the following command: ` git clone https://github.com/XpiritBV/mini-hacks/tree/master/Robot-Challege-Follow-a-straight-line/Source` 
...
The mBot robot has been programmed to follow a path to the finish line. Unfortunately it’s gone a bit lost and it will constantly move the wrong way. 
